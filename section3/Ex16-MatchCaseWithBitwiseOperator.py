question="""This one is similar to a previous exercise, but it uses the bitwise OR (|) operator in addition.  In the coding area, we have defined a country variable.  Below that line, write a match-case block that:
